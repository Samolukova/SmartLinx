...
public sealed class UnprocessableContentStepDefinitions
{
  ...
  // Опредение шагов завершено

 // Сценарий: Приложение не отвечает 422 Unprocessable Content ошибкой на GET запрос, если правила редиректа умной ссылки определяют, 
 // что ее редирект не был временно приостановлен
